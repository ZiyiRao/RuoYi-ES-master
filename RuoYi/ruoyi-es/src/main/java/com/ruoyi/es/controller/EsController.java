...
import com.ruoyi.es.bean.es.ESUser;
...
import com.ruoyi.es.utils.PageUtil;
...
//     * @param type
     ...
     * @return
     */
    @GetMapping("/searchField/{field}/{keyword}")
    public String searchField( @PathVariable("field")String field,@PathVariable("keyword")String keyword,ModelMap mmap){
...
//                    .boolQuery()
//                    .must(QueryBuilders.wildcardQuery("Action",("*"+keyword+"*")))
//                    .must(QueryBuilders.wildcardQuery("DstIP",("*"+keyword1+"*")))
//
//
//            );
//            rq.source(sourceBuilder);
...
////
////                builder.should(QueryBuilders.matchPhraseQuery("IP",keyword));
...
//            return "es/es_search";
////                return getDataTable(object2);
////        }

    }

    @ResponseBody
    @PostMapping("/searchES/{field}/{keyword}")
    public TableDataInfo searchES(@PathVariable("field")String field,@PathVariable("keyword")String keyword) {
//        startPage();
        RestHighLevelClient client = new RestHighLevelClient(
                RestClient.builder(
                        new HttpHost("localhost", 9200, "http"),
...
//            sourceBuilder.query(QueryBuilders.matchAllQuery());
    ...
    public List<EsUserBean> searchAll(){
        RestHighLevelClient client = new RestHighLevelClient(
                RestClient.builder(
                        new HttpHost("localhost", 9200, "http"),
                        new HttpHost("localhost", 9201, "http")));
